<%@ Page Title="Men's Watches" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MensWatches.aspx.cs" Inherits="INFT3050_Assignment1.UserLayer.MensWatches" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="container pb-5 bg-white">
        <!--Heading-->
        <h2 class="text-center py-5 text-black-50">Men's Watches</h2>
        <hr />
        <asp:ListView ID="ProductList" runat="server" GroupItemCount="3" GroupPlaceholderID="groupPlaceholder">
